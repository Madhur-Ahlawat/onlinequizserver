...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="row pt-2 pb-2">
            <div class="col-sm-9">
                <h4 class="page-title"><?php echo $this->lang->line('LIST_PRATICE_QUESTION'); ?></h4>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a
                            href="<?php echo base_url(); ?>admin/dashboard"><?php echo $this->lang->line('DASHBOARD'); ?></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">
                        <?php echo $this->lang->line('LIST_PRATICE_QUESTION'); ?></li>
                </ol>
            </div>
            <div class="col-sm-3">
                <div class="btn-group float-sm-right">
                    <a href="<?php echo base_url(); ?>admin/praticequestion/add"
                        class="btn btn-outline-primary waves-effect waves-light"><?php echo $this->lang->line('ADD_PRATICE_QUESTION'); ?></a>
                </div>
            </div>
        </div>
        <!-- End Breadcrumb-->
            ...
            <div class="">
                <div class="card">
                    <div class="card-header"><i class="fa fa-table"></i>
                        <?php echo $this->lang->line('LIST_PRATICE_QUESTION'); ?> </div>
                    <div class="card-body">
                        <div class="">
...
$(document).ready(function() {
    var dataTable = $('#default-datatable').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'admin/praticequestion/fetch_data'; ?>",
            type: "POST"
        },
        "columnDefs": [{
            "targets": 0,
            ...
            swal({
                ...
                function(isConfirm) {
                    if (isConfirm) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url() . 'admin/praticequestion/delete_data'; ?>",
                            data: {
                                ids: ids_string
                            },
