    ...
    <div class="container-fluid">
            ...
            <div class="col-sm-9">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        Edit Classification</li>
                </ol>
            </div>
            <div class="col-sm-3">
                <div class="btn-group float-sm-right">
                    <a href="<?php echo base_url(); ?>admin/questionlevel"
                        class="btn btn-outline-primary waves-effect waves-light">Classification List</a>
                </div>
            </div>
        </div>
        <!-- End Breadcrumb-->
        ...
        <div class="row">
            <div class="col-lg-12 ">
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">Edit Classification</div>
                        <hr>
                        <form id="edit_level_form" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" value="<?php echo $level->level_name ?>" name="name"
...
function updatelevel() {
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo base_url(); ?>admin/questionlevel/update',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
        ...
        success: function(resp) {
            get_responce_message(resp, 'edit_level_form', 'questionlevel'); 
        }
    });
}
</script>