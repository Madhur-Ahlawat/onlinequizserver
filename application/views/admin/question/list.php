            ...
            <div class="col-sm-9">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <?php echo $this->lang->line('LIST_QUESTION'); ?></li>
                </ol>
            </div>
            <div class="col-sm-3">
                <div class="btn-group float-sm-right">
                    <a href="<?php echo base_url(); ?>admin/question/add"
                        class="btn btn-outline-primary waves-effect waves-light"><?php echo $this->lang->line('ADD_QUESTION'); ?></a>
                </div>
            </div>
        </div>
        <!-- End Breadcrumb-->
            ...
            <div class="">
                <div class="card">
                    <div class="card-header"><i class="fa fa-table"></i>
                        <?php echo $this->lang->line('LIST_QUESTION'); ?> </div>
                    <div class="card-body">
                        <div class="">
                        	<button class="btn btn-xs p-1 btn-danger  float-md-left" id="deleteTriger"><i class="fa fa-trash p-1"></i></button>
...
<script>
    ...
    $(document).ready(function() {
        var dataTable = $('#default-datatable').DataTable({
            ...
            "order": [],
            "ajax": {
                url: "<?php echo base_url() . 'admin/question/fetch_data'; ?>",
                type: "POST"
            },
            "columnDefs": [{
                "targets": 0,
        	...
        	if( $('.deleteRow:checked').length > 0 ){  
                ...
                function (isConfirm) {
                    if (isConfirm) {
		                ...
		                $.ajax({
		                    type: "POST",
		                    url: "<?php echo base_url() . 'admin/question/delete_data'; ?>",
		                    data: {ids:ids_string},
