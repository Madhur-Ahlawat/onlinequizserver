...
class Praticequestion extends CI_Controller {
    ...
    {
        $this->load->view("admin/pratice_question/list");
    }
    ...
    public function add() {
        ...
        $this->load->view("admin/pratice_question/add", $data);
    }
    ...
    public function save() {
        try {
            ...
            $this->form_validation->set_rules('question_level_master_id', 'question level type', 'required');
            if ($this->form_validation->run() == false) {
                ...
                $question_level_master_id = trim($_POST['question_level_master_id']);
                ...
                $cat_id = $this->Common_model->insert($data, 'pratice_question');
    ...
    public function edit() {
        ...
        $id = $_GET['id'];
        $where = 'id="' . $id . '"';
        $data['question'] = (object) $this->Common_model->getById($where, 'pratice_question');
        $data['questionlevel'] = $this->Common_model->get('', 'question_level_master');
        $this->load->view("admin/pratice_question/edit", $data);
    }
    ...
    public function update() {
        ...
        try {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $questionId = $this->Common_model->update($id, 'id', $data, 'pratice_question');
    ...
    public function fetch_data()
    {
        ...
        foreach ($fetch_data as $key => $row) {
            ...
            $sub_array[] = $answer;
            $sub_array[] = ' <a href="' . base_url() . 'admin/praticequestion/edit?id=' . $row->id . '" class="btn btn-xs btn-primary p-1" ><i  class="fa fa-edit p-1"></i></a> <a href="javaScript:void(0)" class="btn btn-xs btn-danger p-1" onclick="delete_record(' . $row->id . ',\'pratice_question\')"><i class="fa fa-trash p-1"></i></a>';
            $data[] = $sub_array;
        }
        $output = array(
