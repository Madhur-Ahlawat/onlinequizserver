...
class Question extends CI_Controller {
    ...
    public function fetch_data()
    {
        ...
        foreach ($fetch_data as $key => $row) {
            ...
            $sub_array[] = $answer;
            $sub_array[] = ' <a href="' . base_url() . 'admin/question/edit?id=' . $row->id . '" class="btn btn-xs btn-primary p-1" ><i  class="fa fa-edit p-1"></i></a> <a href="javaScript:void(0)" class="btn btn-xs btn-danger p-1" onclick="delete_record(' . $row->id . ',\'question\')"><i class="fa fa-trash p-1"></i></a>';
            $data[] = $sub_array;
        }
        $output = array(
